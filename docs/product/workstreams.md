...
| V2-R1-RESUME-01 | 简历资产、版本谱系与简历库 | `READY` | `f4877b1` | `codex/v2-r1-resume-asset-library` | Resume 后端/迁移、resume types/API/composable、简历库页面 | ARCH-01 | 下一项 |
| V2-I1-INTERVIEW-01 | 三模式模拟面试引擎 | `QUEUED` | Resume 集成后冻结 | `codex/v2-i1-three-mode-interview` | Interview 后端/迁移、三模式页面与测试 | RESUME-01 | Resume 后 |
...
1. `V2-F2-FE-02` 已集成；下一步执行 `V2-F2-QA-01`，验证导入、分类、搜索、阅读、桌面原文和删除恢复的真实纵向流程。
