...
| V2-F1-FE-03 | V2 Pipeline 页面 | `READY` | `b58115e25d37f9b2a032c11d3ea15d7e27e74fa0` | `codex/v2-f1-fe-03-pipeline-page` | router、Pipeline view/components/tests | V2-F1-FE-02B、UX-01 | 3 |
...
1. 当前仅 `V2-F1-FE-03` 可分发；它必须从冻结基线创建独立 worktree。
2. FE-03 只能修改 router 和新 Pipeline view/components，不得修改 DesktopShell、V1 页面或 API/types/store。
3. FE-03 集成后再提升 `V2-F1-QA-01`；QA 不与页面实现并行修改相同文件。
