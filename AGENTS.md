...
- 当前真实状态：`docs/baseline.md`
- 产品范围与非目标：`docs/product.md`
- 阶段路线：`docs/roadmap.md`
- 架构与模块边界：`docs/architecture.md`
- 编码和完成标准：`docs/development.md`
- 隐私与 AI 规则：`docs/privacy-and-ai.md`
...
8. 重大产品或架构变化先更新 `docs/decisions.md`，阶段范围变化同步更新 `docs/roadmap.md`。
