<template>
  <section class="evidence-library">
    <header>
      ...
      <div class="header-actions"><button type="button" :disabled="library.loading.value" @click="library.load">刷新</button><button data-test="open-evidence-form" type="button" @click="formOpen = true">新增证据</button></div>
    </header>
...
<style scoped>
.evidence-library{padding:38px 42px;color:var(--ink,#203039)}.evidence-library>header{display:flex;justify-content:space-between;align-items:flex-end;gap:24px;margin-bottom:26px}.evidence-library header p{margin:0;color:var(--brand,#168866);font-weight:800}.evidence-library header h1{margin:6px 0 8px;font-size:30px}.evidence-library header span{color:var(--muted,#71808a)}.header-actions{display:flex;gap:9px}.header-actions button,.state button,.form-actions button{border:1px solid var(--line,#d1dcdf);border-radius:9px;background:var(--surface-solid,#fff);color:var(--ink,#203039);padding:9px 13px}.primary{border-color:var(--brand,#168866)!important;background:var(--brand,#168866)!important;color:#fff}.state{min-height:260px;display:grid;place-content:center;justify-items:center;gap:12px;border:1px solid var(--line,#dfe6e9);border-radius:15px;background:var(--surface-solid,#fff);color:var(--muted,#71808a)}.state strong{color:var(--ink,#203039);font-size:20px}.state.error{color:var(--danger,#a23d35)}.content-layout{display:grid;grid-template-columns:1fr;gap:18px}.content-layout.form-visible{grid-template-columns:minmax(0,1fr) 390px}.evidence-list{display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:12px}.evidence-list article{display:grid;align-content:start;gap:10px;border:1px solid var(--line,#dfe6e9);border-radius:13px;background:var(--surface-solid,#fff);padding:18px}.evidence-title span{color:var(--brand,#168866);font-size:12px;font-weight:800}.evidence-title h2{margin:4px 0 0;font-size:18px}.evidence-list p{display:grid;gap:4px;margin:0;color:var(--copy,#566770);line-height:1.55}.evidence-list p strong{color:var(--ink,#263941);font-size:12px}.evidence-list small{color:var(--muted,#829098)}.tags{display:flex;flex-wrap:wrap;gap:6px}.tags span{border-radius:999px;background:var(--brand-soft,#edf7f3);color:var(--brand,#14765c);padding:5px 8px;font-size:12px}.evidence-form-panel{border:1px solid var(--line,#dfe6e9);border-radius:14px;background:var(--surface-solid,#fff);padding:19px}.form-title{display:flex;justify-content:space-between}.form-title small{color:var(--brand,#168866);font-weight:800}.form-title h2{margin:5px 0 16px}.form-title>button{border:0;background:none;color:var(--muted,#5b6570);font-size:22px}.evidence-form-panel form,.evidence-form-panel label{display:grid;gap:8px}.evidence-form-panel form{gap:13px}.evidence-form-panel label{color:var(--ink,#344751);font-weight:700}.evidence-form-panel input,.evidence-form-panel select,.evidence-form-panel textarea{box-sizing:border-box;width:100%;border:1px solid var(--line,#d4dee2);border-radius:8px;padding:9px 10px;background:var(--surface-solid,#fff);color:var(--ink,#203039);font:inherit}.evidence-form-panel textarea{resize:vertical}.form-actions{display:flex;justify-content:flex-end;gap:8px}.form-error,.inline-error{border:1px solid var(--danger-soft,#efc7c2);border-radius:8px;background:var(--danger-soft,#fff2f0);color:var(--danger,#a23d35);padding:9px 11px}
</style>
