...
const props = withDefaults(defineProps<{ target: JobProject; job?: JobDescription | null; resumeTitle?: string; materialError?: string }>(), { job: null, resumeTitle: '', materialError: '' })
