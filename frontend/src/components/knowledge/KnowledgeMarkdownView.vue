...
<style scoped>
.markdown-view{font-size:14px;line-height:1.75;color:var(--copy);max-width:72ch}
...
.md-code{margin:0 0 12px;padding:12px 14px;border-radius:10px;background:var(--bg-subtle);color:var(--copy);font-size:13px;overflow-x:auto;white-space:pre-wrap}
</style>