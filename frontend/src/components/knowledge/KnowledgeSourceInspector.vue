...
<style scoped>
.inspector{box-sizing:border-box;height:100%;width:284px;min-width:0;border-left:1px solid var(--border-subtle);overflow-y:auto;padding:14px 15px;background:var(--bg-subtle)}
